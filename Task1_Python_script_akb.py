...
def get_page():
    ...
    url = input("Enter the web archive url of a medium article: ").strip()	
	# Code ends here
	
    # handling possible error
    if not re.match(r'https?://web.archive.org/',url):
	    print('Please enter a valid website, or make sure it is a web archive article')
	    sys.exit(1)
